...
urlpatterns = [
    ...
    path('projects/<int:pk>/matches/', views.MatchingInvestors.as_view(), name='matching-investors'),
    ...
    path('investors/<int:pk>/matches/', views.MatchingProjects.as_view(), name='matching-projects')
]
